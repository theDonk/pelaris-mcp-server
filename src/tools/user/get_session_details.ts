    ...
    async ({ sessionId }) => {
      ...
      try {
        ...
        const session = {
          ...
          completedVia: d.completed_via || null,
          externalUrl: d.external_url || null,
          importedActuals: d.imported_actuals ? {
            elapsedSeconds: d.imported_actuals.elapsedSeconds ?? null,
            movingSeconds: d.imported_actuals.movingSeconds ?? null,
            distanceMeters: d.imported_actuals.distanceMeters ?? null,
            averageHeartrate: d.imported_actuals.averageHeartrate ?? null,
            maxHeartrate: d.imported_actuals.maxHeartrate ?? null,
            averageSpeedMps: d.imported_actuals.averageSpeedMps ?? null,
            maxSpeedMps: d.imported_actuals.maxSpeedMps ?? null,
            averageCadence: d.imported_actuals.averageCadence ?? null,
            averageWatts: d.imported_actuals.averageWatts ?? null,
            weightedAverageWatts: d.imported_actuals.weightedAverageWatts ?? null,
